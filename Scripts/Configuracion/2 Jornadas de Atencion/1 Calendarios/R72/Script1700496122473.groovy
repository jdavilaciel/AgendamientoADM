...
WebUI.verifyElementPresent(findTestObject('ADM/1Configuracion/2Jornadas de atencion/1Calendarios/0 btn_Crear(1)/btn_Cancelar'), 
    2)

WebUI.verifyElementPresent(findTestObject('ADM/1Configuracion/2Jornadas de atencion/1Calendarios/0 btn_Crear(1)/btn_Nuevo'), 
    2)

WebUI.verifyElementPresent(findTestObject('ADM/1Configuracion/2Jornadas de atencion/1Calendarios/0 btn_Crear(1)/input_Nombre Calendario'), 
    2)
