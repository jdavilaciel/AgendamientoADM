...
WebUI.comment('Se eliminará una jornada')
...
WebUI.click(findTestObject('ADM/1Configuracion/2Jornadas de atencion/2Jornadas/Jornadas/Lista Jornadas/a_8 Prueba_Borrar'))
