...
WebUI.setText(findTestObject('ADM/1Configuracion/6Modelo de atencion/1Servicios/Datos de Servicio/input_Codigo'), findTestData(
        '7 Servicios').getValue('Código', 8))

WebUI.setText(findTestObject('ADM/1Configuracion/6Modelo de atencion/1Servicios/Datos de Servicio/input_Nombre'), '')
