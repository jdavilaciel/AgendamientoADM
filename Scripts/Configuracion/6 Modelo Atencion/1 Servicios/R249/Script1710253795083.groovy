...
WebUI.comment('Nombre comienza en números')

WebUI.scrollToPosition(0, 0)

WebUI.delay(2)

WebUI.setText(findTestObject('ADM/1Configuracion/6Modelo de atencion/1Servicios/Datos de Servicio/input_Codigo'), findTestData(
        '7 Servicios').getValue('Código', 7))
...
WebUI.setText(findTestObject('ADM/1Configuracion/6Modelo de atencion/1Servicios/Datos de Servicio/textarea_HTML Requisitos'), 
    findTestData('7 Servicios').getValue('Requisitos', 7))
...
WebUI.setText(findTestObject('ADM/1Configuracion/6Modelo de atencion/1Servicios/Datos de Servicio/textarea_HTML Descripcion'), 
    findTestData('7 Servicios').getValue('Descripción', 7))
