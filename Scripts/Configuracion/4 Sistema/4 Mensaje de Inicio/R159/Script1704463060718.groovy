...
WebUI.comment('Ventana Modal Administrador vista Previa')
...
WebUI.click(findTestObject('ADM/1Configuracion/4Sistema/4Mensajes de Inicio/Ventana Modal Administradores/btn_VistaPreviaAdmin'))
