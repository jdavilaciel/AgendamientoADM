...
WebUI.comment('Eliminar un Tipo de usuario')
...
WebUI.click(findTestObject('ADM/1Configuracion/4Sistema/1Tipos de Usuario/Listado de Tipos de Cliente/a_3 Prueba_Borrar'))
