...
WebUI.comment('Boton Actualizar en el parametro 1')
...
WebUI.setText(findTestObject('ADM/1Configuracion/4Sistema/3Parametros Generales/1 Cambios/Valores/input_Valor1'), '5')

WebUI.click(findTestObject('ADM/1Configuracion/4Sistema/3Parametros Generales/1 Cambios/Valores/btn_Actualizar'))
