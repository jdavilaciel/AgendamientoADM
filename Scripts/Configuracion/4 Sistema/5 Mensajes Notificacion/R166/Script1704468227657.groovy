...
WebUI.setText(findTestObject('ADM/1Configuracion/4Sistema/5Mensajes Notificacion/Edicion/input_Nombre mensaje'), 'Prueba')
...
WebUI.click(findTestObject('ADM/1Configuracion/4Sistema/5Mensajes Notificacion/Edicion/btn_Guardar'))
