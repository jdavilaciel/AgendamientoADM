...
WebUI.comment('Boton eliminar dato prueba')
...
WebUI.click(findTestObject('ADM/1Configuracion/4Sistema/5Mensajes Notificacion/Lista de Tipo Cliente/a_3 Prueba Borrar'))
