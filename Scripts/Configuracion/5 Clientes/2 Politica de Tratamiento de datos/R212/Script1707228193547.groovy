...
WebUI.comment('Verificar tabla datos')
...
WebUI.click(findTestObject('ADM/1Configuracion/5Clientes/2Politica de Datos/Poltica de tratamiento de datos personales/label_Ninguno'))
