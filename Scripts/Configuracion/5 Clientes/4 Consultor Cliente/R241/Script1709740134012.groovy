...
WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/4Consultor Cliente/3 Configuracion Campos/Datos Campo Usuario Cliente/input_Expresion regular'), 
    'esta es una prueba del botón limpiar')
...
WebUI.click(findTestObject('ADM/1Configuracion/5Clientes/4Consultor Cliente/3 Configuracion Campos/Datos Campo Usuario Cliente/btn_Limpiar'))
