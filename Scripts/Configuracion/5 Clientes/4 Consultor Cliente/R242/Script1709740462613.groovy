...
WebUI.comment('Botón Guardar')

WebUI.click(findTestObject('ADM/1Configuracion/5Clientes/4Consultor Cliente/3 Configuracion Campos/Lista campos usuario/td_1 Correo electronico'), 
...
WebUI.click(findTestObject('ADM/1Configuracion/5Clientes/4Consultor Cliente/3 Configuracion Campos/Datos Campo Usuario Cliente/btn_Guardar'))
