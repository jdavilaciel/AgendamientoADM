...
WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Identificacion'), 
    GlobalVariable.ClienteIdentificacion)

WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Nombres'), GlobalVariable.ClienteNombre)

WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Apellidos'), GlobalVariable.ClienteApellido)
...
WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Fecha Nacimiento (ddmmaaaa)'), 
    GlobalVariable.ClienteFechaNac)

WebUI.selectOptionByLabel(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/select_Genero'), 
    'Masculino', false)

WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Direccion'), GlobalVariable.ClienteDireccion)
...
WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Telefono'), GlobalVariable.ClienteTelefono)

WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Celular'), GlobalVariable.ClienteCelular)

WebUI.setText(findTestObject('ADM/1Configuracion/5Clientes/1Maestro de Clientes/Datos Cliente/input_Correo Electronico'), 
    GlobalVariable.ClienteCelular)
