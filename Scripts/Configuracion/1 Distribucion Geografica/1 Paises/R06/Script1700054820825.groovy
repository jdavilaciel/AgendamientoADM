...
WebUI.setText(findTestObject('ADM/1Configuracion/1Distribucion geografica/1Paises/input_Nombre Pais'), 'chi')

WebUI.click(findTestObject('ADM/1Configuracion/1Distribucion geografica/1Paises/btn_Buscar'), FailureHandling.STOP_ON_FAILURE)
