...
WebUI.verifyElementPresent(findTestObject('ADM/1Configuracion/1Distribucion geografica/1Paises/0 btn_NuevoPais(1)/input_Codigo Pais'), 
    2)

WebUI.verifyElementPresent(findTestObject('ADM/1Configuracion/1Distribucion geografica/1Paises/0 btn_NuevoPais(1)/input_Nombre Pais'), 
    2)
