...
WebUI.verifyElementPresent(findTestObject('ADM/0Principal/a_Agendas'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/0Principal/a_Citas'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/0Principal/a_Configuracion'), 2)
