...
WebUI.setText(findTestObject('ADM/1Configuracion/1Distribucion geografica/2Departamentos o estados/input_Nombre Estado'), 
    'Cundinamarca')
...
WebUI.click(findTestObject('ADM/1Configuracion/1Distribucion geografica/2Departamentos o estados/btn_Limpiar'))
