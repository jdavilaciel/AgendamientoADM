...
WebUI.comment('Eliminar un funcionario')
...
WebUI.click(findTestObject('ADM/1Configuracion/3Seguridad/3Funcionarios/0 Listado/a_Prueba3_btnBorrar'), FailureHandling.STOP_ON_FAILURE)
