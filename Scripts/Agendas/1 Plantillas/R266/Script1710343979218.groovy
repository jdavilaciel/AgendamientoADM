...
WebUI.comment('Botón Cancelar')

WebUI.click(findTestObject('ADM/2Agendas/1 Plantillas/Plantillas por oficina/btn_Nueva Plantilla(1)/2 Calendario y Agenda/btn_Cancelar'), 
