...
WebUI.click(findTestObject('ADM/2Agendas/3 Agendas Por Oficina/btn_Buscar'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.comment('VERIFICAR EXCEL EN CARPETA DE DESCARGAS')

WebUI.click(findTestObject('ADM/2Agendas/3 Agendas Por Oficina/btn_1 ExportarExcel'))
