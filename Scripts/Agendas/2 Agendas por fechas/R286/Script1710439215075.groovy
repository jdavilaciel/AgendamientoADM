...
WebUI.comment('Eliminar suspendidas')
...
WebUI.scrollToElement(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Suspendidas'), 3)

WebUI.click(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Suspendidas'))
