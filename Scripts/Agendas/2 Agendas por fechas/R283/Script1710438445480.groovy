...
WebUI.comment('Suspendidas a Disponible')
...
WebUI.scrollToElement(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Suspendidas a Disponible'), 3)

WebUI.click(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Suspendidas a Disponible'))
