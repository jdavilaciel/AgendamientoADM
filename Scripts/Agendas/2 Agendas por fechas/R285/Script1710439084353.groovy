...
WebUI.comment('Reservadas a Disponible')
...
WebUI.scrollToElement(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Reservadas a Disponible'), 3)

WebUI.click(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Reservadas a Disponible'))
