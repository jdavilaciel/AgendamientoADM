...
WebUI.comment('Boton exportar excel')
...
WebUI.click(findTestObject('ADM/2Agendas/2 Agendas por fechas/a1_Exportar Excel'))

WebUI.comment('VERIFICAR CARPETA DE DESCARGAS')
