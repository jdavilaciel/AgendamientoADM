...
WebUI.selectOptionByLabel(findTestObject('ADM/2Agendas/2 Agendas por fechas/select_Estado'), findTestData('8Agendas').getValue(
        'Estado', 1), false)
...
WebUI.verifyElementPresent(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Suspendidas a Disponible'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Disponibles a Suspendida'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Reservadas a Disponible'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Suspendidas'), 2)

WebUI.verifyElementPresent(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Todas'), 2)
