...
WebUI.scrollToElement(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Todas'), 3)

WebUI.click(findTestObject('ADM/2Agendas/2 Agendas por fechas/btn_Eliminar Todas'))
